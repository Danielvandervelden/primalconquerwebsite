...
<div class="main-content-container rules">
    ...
    <div class="form-wrapper margin-center padding-top">
        ...
        <div class="form-group">
            ...
            <input class="form-control" name="forgot_password_username" type="text" placeholder="Enter your current username." value="<?php echo $username ?>">
        </div>

        <div class="form-group">
            <label class="white hm" for="password"> Current Email</label>
            <input name="forgot_password_email" class="form-control" type="email" placeholder="Enter your current password">
        </div>
