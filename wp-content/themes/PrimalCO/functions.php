...
function primal_files()
{
	...
	wp_enqueue_style('owl-carousel', get_template_directory_uri() . '/stylecomponents/owl-carousel/owl.carousel.min.css');
	wp_enqueue_style('owl-carousel-default', get_template_directory_uri() . '/stylecomponents/owl-carousel/owl.theme.default.min.css');
