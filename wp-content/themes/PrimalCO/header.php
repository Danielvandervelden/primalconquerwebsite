        ...
        <header class="parallax-container" style="background-image: url(<?php echo $headerImage ?>);">
            <div class="header-container">
                        ...
                        <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
                            <ul class="navbar-nav navbar-right mt-2 mt-lg-0">
                                ...
                                <li class="nav-item dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                        <div class="dropdown-item login">
                                            <div class="form-wrapper">
                                                <h2 class="hs white">Login</h2>
                                                <form method="post" action="<?php echo site_url() ?>">
                                                    ...
                                                    <button name="login" class="btn btn-dark btn-block" type="submit">Login</button><a class="center" href="<?php echo site_url('/forgot') ?>">Forgot password</a>
                                                </form>
                                ...
                                <li class="nav-item dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                        <a class="dropdown-item logged" href="<?php echo site_url('/profile') ?>">My Profile</a>
                                        <form action="/" method="POST">
                                        <button name="logout" class="dropdown-item logged btn btn-block transparent btn-lg" type="submit">Logout</button>
                                        </form>
                                    </div>
                                </li>
                                <?php } ?>
                ...
                <div class="text-message full-opacity">
                    ...
                    <p class="t-shadow">You have now entered an era far before the current. You've made a jump in back in time to a place where Conquer Online was all about making friends, having fun and gathering resources through sheer hard work. This server is not for
                        the faint hearted. The only thing you can do to become the best is put in effort. Have you got what it takes? Then register an account, download the client and go forth!
                    </p>
                </div>
